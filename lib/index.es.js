...
function formatMessage(config, state) {
  ...
  var id = messageDescriptor.id,
      ...
      message = messageDescriptor.message;
  ...
  var messageWithId = getFirstString(message, messages && messages[id]);
  ...
  if (!hasValues && process.env.NODE_ENV === 'production') {
    return getFirstString(messageWithId, defaultMessage, id);
  }
  ...
  if (isString(messageWithId)) {
    try {
      var formatter = state.getMessageFormat(messageWithId, locale, formats);
  ...
  if (!isString(formattedMessage)) {
    onError(createError('Cannot format message: "' + id + '", ' + ('using message ' + (isString(messageWithId) || isString(defaultMessage) ? 'source' : 'id') + ' as fallback.')));
  }

  return getFirstString(formattedMessage, messageWithId, defaultMessage, id);
}
...
var FormattedMessage = function (_Component) {
  ...
  createClass(FormattedMessage, [{
    ...
    value: function render() {
      ...
      var descriptor = { id: id, description: description, defaultMessage: defaultMessage, message: message };
