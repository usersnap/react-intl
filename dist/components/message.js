...
var FormattedMessage = /** @class */ (function (_super) {
    ...
    FormattedMessage.prototype.render = function () {
        ...
        return (React.createElement(injectIntl_1.Context.Consumer, null, function (intl) {
            ...
            var _d = _this.props, id = _d.id, description = _d.description, defaultMessage = _d.defaultMessage, message = _d.message, values = _d.values, children = _d.children, _e = _d.tagName, Component = _e === void 0 ? Text : _e;
